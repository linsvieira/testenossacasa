...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'backup_nossacasateste1_279bd71faa3580851134_20220205204932_archive.zip';
	const ARCHIVE_SIZE		 = '42707576';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '279bd71-05204932';
    const SECONDARY_PACKAGE_HASH = '87197b4-05204932';
	const VERSION			 = '1.4.4';
